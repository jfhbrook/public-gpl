...
class Workspace {
    ...
    [boolean]TestArchive([Version]$Version) {
        return Test-Item $this.GetArchivePath($Version)
    }
    ...
    [boolean]TestInstall([Version]$Version) {
        return Test-Item $this.GetInstallPath($Version)
    }

    [System.IO.FileInfo]GetInstall([Version]$Version) {
