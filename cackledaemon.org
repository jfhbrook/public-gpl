...
Describe "New-CackledaemonWD" {
    It "creates a new and initialized working directory" {
        Import-Cackledaemon
        New-EnvironmentFixture
        New-CackledaemonWD
        New-Item $Env:AppData
        New-Item $Env:ProgramFiles

        Get-Item 'TestDrive:\Cackledaemon' | Should -Exist
        Get-Item 'TestDrive:\Cackledaemon\Configuration.ps1' | Should -Exist
        Get-Item 'TestDrive:\Cackledaemon\Shortcuts.csv' | Should -Exist
        Get-Item 'TestDrive:\Cackledaemon\FileTypeAssociations.csv' | Should -Exist
    }
}
...
function Get-FileTypeAssociationsConfig {
    ImportCsv -Path (Join-Path $CackledaemonWD './Associations.csv') | ForEach-Object {
        [FileTypeAssociationRecord]$_
    }
}
