...
#+BEGIN_SRC powershell :tangle ./Cackledaemon/shortcuts.csv
...
#+BEGIN_SRC csv :tangle ./Cackledaemon/Associations.csv
...
function Install-Emacs {
    ...
    if ($Workspace.TestInstall($TargetVersion)) {
        ...
        $Install = Extract-EmacsArchive $Archive
    }
...
function New-ServerFileDirectory {
    [CmdletBinding()]
    param(
        [string]$Path = Join-Path $DefaultServerFileDirectory
    )
