    ...
    It 'fetches emacs downloads' {
        ...
        Mock -ModuleName Cackledaemon Invoke-WebRequest {
            ...
            if (Test-Path $TapePath) {
                $Response = New-Object FakeResponse
                $Response.Links = (Get-Content $TapePath | ConvertFrom-Json).Links | ForEach-Object {
                    $Link = New-Object FakeLink
                    $Link.href = $_.href
                    return $Link
                }
                return $Response
            } else {
                $OriginalCommand = Get-Command Invoke-WebRequest -CommandType Cmdlet
                $Result = & $OriginalCommand -Uri $Uri
        ...
        $Downloads[0].Href | Should -Not -Be $null
        $Downloads[0].Version | Should -Not -Be $null
    }
}
